...
const PIN_TYPES = [
  { value: 'project', label: 'Community Project', color: '#4C764C' },
  { value: 'business', label: 'Local Business', color: '#10B981' },
  { value: 'event', label: 'Community Event', color: '#F59E0B' },
  { value: 'issue', label: 'Community Issue', color: '#EF4444' },
  { value: 'environment', label: 'Environmental', color: '#059669' },
  { value: 'faith', label: 'Faith & Fellowship', color: '#8B5CF6' },
  { value: 'community', label: 'Community & Social', color: '#EC4899' }
];

const AddPinModal: React.FC<AddPinModalProps> = ({ isOpen, onClose, onSubmit, location }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center space-x-2">
            <MapPin className="w-5 h-5 text-[#4C764C]" />
            <h2 className="text-lg font-semibold text-gray-900">Add New Pin</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <Button
              type="submit"
              className="flex-1 bg-[#4C764C] hover:bg-[#3d5f3d]"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
                <div className="flex items-center space-x-2">
